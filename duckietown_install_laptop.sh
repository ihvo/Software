...
sudo apt-get install ros-kinetic-phidgets-drivers ros-kinetic-imu-tools -y

# Additional ROS pkgs
sudo apt-get install ros-kinetic-{tf-conversions,cv-bridge,image-transport,camera-info-manager,theora-image-transport} -y
